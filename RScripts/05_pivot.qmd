...
Alternatively in 1 step, value column names will be extracted from parts of the wide colnames. This requires either a name pattern or a separator:
...
rawdata_wide <-
  ...
  pivot_wider(
    names_from = c(what_was_measured, Visit),
